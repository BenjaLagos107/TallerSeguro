...
for (let i = 25; i < 90; i++) {
    if (lines[i].includes("switchView('landing');")) {
...
if (startLogout !== -1 && endLogout !== -1) {
    const newLogoutLines = [
        ...
        "        // Activamos la pestaña de perfil por si acaso (opcional pero ayuda si tab logic existe)",
...
console.log('done replacing by lines');
